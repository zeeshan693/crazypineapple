// assets/js/application-design.js
...
document.addEventListener("DOMContentLoaded", () => {
    ...
    // -------------------------------------------------
    // SET INITIAL STATES FOR APPLICATION DESIGN PAGE
    // -------------------------------------------------
    ...
    statNumbers.forEach(stat => {
        ...
        // Parse the target number (handle values like "4.8+", "500K+", "99.9%", "100%")
    ...
    // Delivery card hover animations (enhanced)
